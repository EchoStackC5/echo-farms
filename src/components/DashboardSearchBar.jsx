...
export default function DashboardSearchBar(){
    ...
    return(
        ...
        // />
          <div className="flex bg-backgrounds border border-light-border px-2 md:px-6 py-2 gap-2 rounded-full max-w-xs md:max-w-lg focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-green-700">
